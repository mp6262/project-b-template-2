...
function preload() {
  bgm1 = loadSound("js/assets/Sonic Youth - Youth Against Fascism [ ezmp3.cc ].mp3");
  bgm2 = loadSound("js/assets/The Big Three Killed My Baby [ ezmp3.cc ].mp3");
  bgImage= loadImage("js/assets/90s-aesthetic.jpg")
}
