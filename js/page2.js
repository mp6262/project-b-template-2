...
function preload() {
  bgm1 = loadSound("js/assets/War [ ezmp3.cc ].mp3");
  bgm2 = loadSound("js/assets/Bob Marley - Get Up Stand Up [HQ Sound] [ ezmp3.cc ].mp3");
  bgImage= loadImage("js/assets/70s aesthetic.jpg")
}
