...
function preload() {
  bgm1 = loadSound("js/assets/Green Day - American Idiot [Official Music Video] [ ezmp3.cc ].mp3");
  bgm2 = loadSound("js/assets/Kendrick Lamar - Alright (Official Music Video) [ ezmp3.cc ].mp3");
  bgImage= loadImage("js/assets/y2k.jpg")
}
