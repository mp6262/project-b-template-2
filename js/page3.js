...
function preload() {
  bgm1 = loadSound("js/assets/Public Enemy - Fight The Power (Official Music Video) [ ezmp3.cc ].mp3");
  bgm2 = loadSound("js/assets/Sting - Russians [ ezmp3.cc ].mp3");
  bgImage= loadImage("js/assets/80s-aesthetic.jpg")
}
